...
$env.jupyterhub.shared_volume = {
  ...
  home_size: 60, # Total size of home dir volume, accounting for all users; In GB; if this is left null, users will not have persistent storage
  data_size: 40, # Total size of /share mount, in GB; if this is left null, no additional storage is allocated for shared data
...
$env.jupyterhub.jhub = {
  ...
  image_name: "unidata/uncc26f", # String: Defaults to unidata/$env.jupyterhub.cluster.name if kept `null` here
