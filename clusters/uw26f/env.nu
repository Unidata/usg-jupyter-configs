...
$env.jupyterhub.shared_volume = {
  ...
  home_size: 300, # Supports up to 27 users × 10 GB/user with some headroom
  data_size: 30, # Requested shared storage
...
$env.jupyterhub.jhub = {
  ...
  admins: [],
  image_name: unidata/uw26f,
  image_tag: 2026Aug25_211157_36c8,

  git_repos: []

  user_placeholders: 4,
  desired_profiles: ["Standard" "Medium" "Unidata Desktop"]
