...
$env.jupyterhub.shared_volume = {
  ...
  home_size: 120, # 10 users × 10 GB/user, with headroom
  data_size: 20, # Requested shared storage for starter scripts
...
$env.jupyterhub.jhub = {
  ...
  admins: [],
  image_name: unidata/vsu26f,
  image_tag: 2026Aug26_200829_977e,
  git_repos: []
  user_placeholders: 4,
